...
public class UserAdminController {
	...
	public String list(Model model) {
		List<User1> users = accountService.getAllUser();
	...
	public String update(@Valid @ModelAttribute("preloadUser") User1 user,@Valid Long fengchengs, RedirectAttributes redirectAttributes) {
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
		User1 user = accountService.getUser(id);
