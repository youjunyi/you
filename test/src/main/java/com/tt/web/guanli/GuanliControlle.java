...
public class GuanliControlle {
	...
	@RequestMapping(value="typetjt")
	public String typetjt(Model model){
		List<Map<String,String>> list =  mpts.typetj();
		List<String> list1= new ArrayList<String>();
		List<Object> list2= new ArrayList<Object>();
		List<Object> list3= new ArrayList<Object>();
		for(int i =0;i<list.size();i++){
			list1.add(list.get(i).get("type_name"));
		}
		for(int i =0;i<list.size();i++){
			list2.add(list.get(i).get("cosmetics_count"));
		}
		for(int i =0;i<list.size();i++){
			list3.add(list.get(i).get("cosmetics_sale_count"));
		}
		String json  =  mapper.toJson(list1);
		String json1  =  mapper.toJson(list2);
		String json2 =  mapper.toJson(list3);
