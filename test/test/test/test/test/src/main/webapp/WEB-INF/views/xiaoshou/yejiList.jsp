...
<c:if test="${not empty message}">
	...
	<div>
		<div>
			<form class="form-search" action="#">
				销售时间:<input type="text" id="d4311" name="search_GTE_czsj" class="input-medium  Wdate" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'d4312\')||\'2100-10-01\'}'})" value="${param.search_GTE_czsj}"> 
				到<input type="text" id="d4312" name="search_LTE_czsj" class="input-medium Wdate" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'d4311\')}',maxDate:'2100-10-01'})" value="${param.search_LTE_czsj}"> 
	...
	<thead><tr><th>序号</th><th style="white-space:nowrap">货物号</th><th style="white-space:nowrap">名称</th><th style="white-space:nowrap">类型</th><th style="white-space:nowrap">适配型号</th><th>金额</th><th>数量</th><th>交款方式</th><th>销售日期</th><th>销售人员</th><th>状态</th><shiro:hasRole name="admin"><th>操作</th></shiro:hasRole></tr></thead>
		<tbody id="t1">
